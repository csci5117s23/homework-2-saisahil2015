...
export declare const clerkApi: {
    ...
    authenticateRequest: ({ apiKey: runtimeApiKey, secretKey: runtimeSecretKey, frontendApi: runtimeFrontendApi, proxyUrl: runtimeProxyUrl, publishableKey: runtimePublishableKey, jwtKey: runtimeJwtKey, isSatellite: runtimeIsSatellite, domain: runtimeDomain, searchParams, ...rest }: Omit<import("@clerk/backend/dist/types/tokens/request").AuthenticateRequestOptions, "apiUrl" | "apiVersion">) => Promise<import("@clerk/backend/dist/types/tokens/authStatus").RequestState>;
    localInterstitial: typeof import("@clerk/backend/dist/types/tokens/interstitial").loadInterstitialFromLocal;
