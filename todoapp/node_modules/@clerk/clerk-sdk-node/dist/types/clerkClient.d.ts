...
export declare function Clerk(options: ClerkOptions): {
    ...
    authenticateRequest: ({ apiKey: runtimeApiKey, secretKey: runtimeSecretKey, frontendApi: runtimeFrontendApi, proxyUrl: runtimeProxyUrl, publishableKey: runtimePublishableKey, jwtKey: runtimeJwtKey, isSatellite: runtimeIsSatellite, domain: runtimeDomain, searchParams, ...rest }: Omit<import("@clerk/backend").AuthenticateRequestOptions, "apiUrl" | "apiVersion">) => Promise<import("@clerk/backend").RequestState>;
    localInterstitial: typeof import("@clerk/backend").loadInterstitialFromLocal;
 ...
 * Stand-alone express middlewares bound to the pre-initialised clerkClient
 */
export declare const ClerkExpressRequireAuth: (options?: import("./types").ClerkMiddlewareOptions) => import("./types").MiddlewareRequireAuthProp;
export declare const ClerkExpressWithAuth: (options?: import("./types").ClerkMiddlewareOptions) => import("./types").MiddlewareWithAuthProp;
/**
