...
export declare const authenticateRequest: (clerkClient: ReturnType<typeof Clerk>, apiKey: string, secretKey: string, frontendApi: string, publishableKey: string, req: IncomingMessage, options?: ClerkMiddlewareOptions) => Promise<RequestState>;
